...
if [ $(uname) = "Darwin" ]; then
  clang++ panoview.cpp Universal/lodepng.cpp macOS/dlgmodule.mm macOS/config.cpp -o panoview -std=c++17 -ObjC++ -framework OpenGL -framework GLUT -DGL_SILENCE_DEPRECATION -framework Cocoa -m64
  ...
  clang++ panoview.cpp Universal/lodepng.cpp xlib/dlgmodule.cpp -o panoview -std=c++17 -I/usr/local/include -L/usr/local/lib -lSDL2 -lGL -lGLU -lglut -lm -lpthread -lX11 -lutil -lc -m64
else
