...
if [ $(uname) = "Darwin" ]; then
  clang++ panoview.cpp Universal/lodepng.cpp macOS/dlgmodule.mm macOS/config.cpp -o panoview -std=c++17 -ObjC++ -framework OpenGL -framework GLUT -framework Cocoa -m64
